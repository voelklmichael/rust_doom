...
pub fn m_save_defaults_alternate(main: *mut i8, extra: *mut i8) {
    todo!("original: M_SaveDefaultsAlternate")
}

/// C function: M_SetConfigDir
pub fn m_set_config_dir(dir: *mut i8) {
    todo!("original: M_SetConfigDir")
}

/// C function: M_BindVariable
pub fn m_bind_variable(name: *mut i8, variable: *mut std::ffi::c_void) {
    todo!("original: M_BindVariable")
}

/// C function: M_SetVariable
pub fn m_set_variable(name: *mut i8, value: *mut i8) -> boolean {
    todo!("original: M_SetVariable")
}

/// C function: M_GetIntVariable
pub fn m_get_int_variable(name: *mut i8) -> i32 {
...
pub fn m_get_float_variable(name: *mut i8) -> f32 {
    todo!("original: M_GetFloatVariable")
}

/// C function: M_SetConfigFilenames
pub fn m_set_config_filenames(main_config: *mut i8, extra_config: *mut i8) {
    todo!("original: M_SetConfigFilenames")
}

/// C function: M_GetSaveGameDir
pub fn m_get_save_game_dir(iwadname: *mut i8) -> *mut i8 {
